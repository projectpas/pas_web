...
export class laborAndOverheadCostEndpointservice extends EndpointFactory {
    ...
    getLaborAndOverheadCostEndpoint<T>(): Observable<T> {
        ...
        return this.http.get<any>(this.laborandoverheadcostUrl, this.getRequestHeaders())
    ...
    getNewLaborAndOverheadCostEndpoint<T>(userObject: any): Observable<T> {
        ...
        return this.http.post<any>(this._laborandoverheadcostUrlNew, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    createLaborOHSettings<T>(userObject: any): Observable<T> {
        return this.http.post<any>(this._createLaborOHSettingsUrl, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
