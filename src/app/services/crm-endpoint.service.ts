...
export class CrmEndpoint extends EndpointFactory {
    ...
    getNewDealEndpoint<T>(userObject: any): Observable<T> {
        ...
        return this.http.post<any>(this._dealUrlNew, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    getNewLeadEndpoint<T>(userObject: any): Observable<T> {
        ...
        return this.http.post<any>(this._leadUrlNew, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    getNewOpportunityEndpoint<T>(userObject: any): Observable<T> {
        ...
        return this.http.post<any>(this._opportunityUrlNew, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    getDealNames<T>(): Observable<T> {
        ...
        return this.http.get<any>(this.getDealNamesUrl, this.getRequestHeaders())
            .pipe(catchError(error => {
