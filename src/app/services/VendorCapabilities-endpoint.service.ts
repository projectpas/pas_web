...
export class VendorCapabilitiesEndpoint extends EndpointFactory {
    ...
    getvendorcapabilitiesEndpoint<T>(): Observable<T> {
        ...
        return this.http.get<any>(this.vendorcapabilitiesUrl, this.getRequestHeaders())
    ...
    getNewGatecodeEndpoint<T>(userObject: any): Observable<T> {
        ...
        return this.http.post<any>(this._vendorcapabilitiesUrlNew, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    deleteAirCraftEndpoint<T>(id: any, updatedBy: any): Observable<T> {
        return this.http.put<any>(`${this._vendorItemMasterAircraftMappedDelete}/?id=${id}&updatedBy=${updatedBy}`, JSON.stringify({}), this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    getNewitemVendorAircraftEndpoint<T>(userObject: any): Observable<T> {
        return this.http.post<any>(this._VendorMasterAircraftPostUrlNew, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
