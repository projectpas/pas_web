...
export class SalesOrderService {
  ...
  marshalSOPartToSave(selectedPart, userName) {
    ...
    partNumberObj.unitSalePrice = selectedPart.salesPricePerUnit ? selectedPart.salesPricePerUnit: 0;
    ...
    partNumberObj.discountAmount = selectedPart.salesDiscountPerUnit ? selectedPart.salesDiscountPerUnit : 0;
    ...
    partNumberObj.salesDiscountExtended = selectedPart.salesDiscountExtended ? selectedPart.salesDiscountExtended : 0;
    ...
    partNumberObj.markupPerUnit = selectedPart.markupPerUnit ? selectedPart.markupPerUnit : 0;
    partNumberObj.controlNumber = selectedPart.controlNumber;
    partNumberObj.grossSalePrice = selectedPart.grossSalePrice ? selectedPart.grossSalePrice : 0;
    partNumberObj.grossSalePricePerUnit = selectedPart.grossSalePricePerUnit ? selectedPart.grossSalePricePerUnit: 0;
    partNumberObj.taxType = selectedPart.taxType;
    partNumberObj.taxAmount = selectedPart.taxAmount ? selectedPart.taxAmount : 0;
