...
export class LeadSourceEndpointService extends EndpointFactory {
    ...
    getLeadSourceEndpoint<T>(): Observable<T> {
        ...
        return this.http.get<any>(this.LeadSourceUrl, this.getRequestHeaders())
    ...
    getAllLeadSourceEndpoint<T>(): Observable<T> {
        ...
        return this.http.get<any>(this.LeadSourceAllUrl, this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    getLeadSourceLiteEndpoint<T>(): Observable<T> {
        ...
        return this.http.get<any>(this._leadSourceLiteUrl, this.getRequestHeaders())
            .pipe(catchError(error => {
    ...
    getNewActionEndpoint<T>(userObject: any): Observable<T> {
        ...
        return this.http.post<any>(this._leadSourcePostUrl, JSON.stringify(userObject), this.getRequestHeaders())
            .pipe(catchError(error => {
