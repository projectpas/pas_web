...
export class EmployeesManagementStructureComponent implements OnInit, AfterViewInit {
    ...
    getManagementStructureData() {
        ...
        this.isSpinnerVisible = true;
        this.employeeService.getStoredEmployeeManagementStructure(this.employeeId).subscribe((managementStructureList: any[]) => {
            this.isSpinnerVisible = false;
    ...
    loadEmployeeRoles() {
        this.isSpinnerVisible = true;
        this.employeeService.getAllRolesOfEmployee(this.currentUserMasterCompanyId).subscribe(
            results => {
    ...
    loadManagementStructure() {
        this.isSpinnerVisible = true;
        this.legalEntityService.getManagemententity(this.currentUserMasterCompanyId).subscribe(
            (results: any) => {
