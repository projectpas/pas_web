...
export class QuoteViewComponent implements OnInit, OnChanges {
  ...
  saveWorkOrderExclusionsList($event) {}
  updateWorkOrderExclusionsList($event) {}
  getExclusionListByWorkOrderId() {}
  saveWorkOrderFreightsList($event){}
  updateWorkOrderFreightsList($event) {}
  getFreightListByWorkOrderId() {}
  saveworkOrderLabor($event){}
  saveWorkOrderChargesList($event) {}
  updateWorkOrderChargesList($event){}
  createChargeQuote($event){}
  getChargesListByWorkOrderId(){}
  editMaterialList(matQuotation){}
  deleteMaterialList(inparam){}
  markupChanged(arr, typ) {}
  tmchange() {}
}