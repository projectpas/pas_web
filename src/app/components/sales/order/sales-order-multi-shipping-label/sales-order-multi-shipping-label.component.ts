...
@Component({
  selector: "app-sales-order-multi-shipping-label",
  templateUrl: "./sales-order-multi-shipping-label.component.html",
  styleUrls: ["./sales-order-multi-shipping-label.component.scss"]
})
export class SalesMultiShippingLabelComponent implements OnInit {
