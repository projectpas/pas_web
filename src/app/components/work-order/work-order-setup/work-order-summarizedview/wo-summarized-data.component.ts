...
export class WoSummarizedDataComponent implements OnInit, OnChanges {
    ...
    materialListHeader = [
        ...
        {"header": "Stk Line Num","field": "stockLineNo",width:"100px"},
        {"header": "Stk Type","field": "stockType",width:"100px"},
        {"header": "Cntrl #", "field": "controllerId",width:"100px"},
        {"header": "Cntrl Num","field": "controllerNo",width:"100px"},
        {"header": "Cond #","field": "condition"},
        {"header": "Item Type","field": "itemType",width:"100px"},
        {"header": "Qty Required","field": "quantityReq",width:"80px"},
        {"header": "Qty OH","field": "quantityOnHand",width:"80px"},
        {"header": "Qty Avail","field": "quantityAvailable",width:"80px"},
        {"header": "Qty Iss'd","field": "qtyssued",width:"80px"},
        {"header": "Unit Cost", "field": "unitCost",width:"80px"},
        { "header": "Ext. Cost", "field": "extendedCost",width:"90px"},
