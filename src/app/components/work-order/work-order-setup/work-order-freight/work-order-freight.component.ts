...
export class WorkOrderFreightComponent implements OnInit, OnChanges {
    ...
    auditHistoryHeaders = [
        ...
        { field: 'shipVia', header: 'Ship Via',isRequired:true ,isCheckbox:false,isDate:false,width:"60px"},
        { field: 'weight', header: 'Weight',isRequired:false ,isCheckbox:false,isDate:false},
        { field: 'uom', header: 'UOM',isRequired:false ,isCheckbox:false,isDate:false,width:"60px"},
        { field: 'length', header: 'Length',isRequired:false ,isCheckbox:false,isDate:false,width:"60px"},
        { field: 'height', header: 'Height',isRequired:false ,isCheckbox:false,isDate:false,width:"60px"},
        { field: 'width', header: 'Width',isRequired:false ,isCheckbox:false,isDate:false,width:"60px"},
        ...
        { field: 'amount', header: 'Amount',isRequired:true ,isCheckbox:false,isDate:false,width:"60px"},
        { field: 'isDeleted', header: 'Is Deleted',isRequired:false ,isCheckbox:true,isDate:false,width:"60px"},
      ...
      auditHistoryQuoteHeaders = [
        ...
        { field: 'weight', header: 'Weight',isRequired:false ,isCheckbox:false,isDate:false,width:"60px"},
