...
export class WorkOrderCompleteMaterialListComponent implements OnInit, OnDestroy {
    ...
    cols = [
        ...
        { field: 'serialNumber', header: 'Ser Num', align: 0 },
        ...
        { field: 'quantityReserved', header: "Qty Res'd", align: 1, width: "60px" },
        { field: 'quantityIssued', header: "Qty Iss'd", align: 1, width: "60px" },
        ...
        { field: 'partQuantityOnOrder', header: 'Qty On Ord', align: 1, width: "82px" },
        { field: 'qunatityBackOrder', header: 'Qty on BK Ord', align: 1, width: "100px" },
        ...
        { field: 'extendedCost', header: 'Ext. Cost', align: 1, width: "90px" },
    ...
    auditHistory = [
        ...
        { field: 'quantityReserved', header: "Qty Res'd" },
        { field: 'quantityIssued', header: "Qty Iss'd" },
    ...
    initColumns() {
        ...
        this.summaryColumns = [
            ...
            { field: 'qtyOnOrder', header: 'Qty On Ord', align: 1, width: "86px" },
            { field: 'qtyOnBkOrder', header: 'Qty on BK Ord', align: 1, width: "110px" },
        ...
        this.childColumnsData = [
            ...
            { field: 'serialNumber', header: 'Ser Num', align: 0, width: "70px" },
            { field: 'partNumber', header: 'PN', align: 0, width: "160px" },
            { field: 'partDescription', header: 'PN Description', align: 0, width: "200px" },
            { field: 'condition', header: 'Cond', align: 0, width: "100px" },
            { field: 'mandatoryOrSupplemental', header: 'Request Type', align: 0, width: "110px" },
            ...
            { field: 'stocklineQtyReserved', header: "Qty Res'd", align: 1, width: "60px" },
            { field: 'stocklineQtyIssued', header: "Qty Iss'd", align: 1, width: "60px" },
