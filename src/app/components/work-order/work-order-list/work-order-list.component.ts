...
export class WorkOrderListComponent implements OnInit {
    ...
    headers = [
        { field: 'workOrderNum', header: 'WO NO',width:'130px !important' },
        { field: 'partNoType', header: 'MPN',width:'200px !important' },
        { field: 'pnDescriptionType', header: 'MPN Description',width:'200px !important' },
        { field: 'workScopeType', header: 'Work Scope',width:'130px !important' },
        { field: 'priorityType', header: 'Priority',width:'130px !important' },
        { field: 'customerName', header: 'Customer Name',width:'200px !important' },
        { field: 'customerType', header: 'Customer Type',width:'130px !important' },
        { field: 'openDate', header: 'Open Date',width:'130px !important' },
        { field: 'customerRequestDateType', header: 'Cust Req Date',width:'130px !important' },
        { field: 'promisedDateType', header: 'Promise Date' ,width:'130px !important'},
        { field: 'estimatedShipDateType', header: 'Est. Ship Date',width:'130px !important' },
        { field: 'estimatedCompletionDateType', header: 'Shipped Date',width:'130px !important' },
        { field: 'stageType', header: 'Stage Code',width:'130px !important' },
        { field: 'workOrderStatusType', header: 'Status',width:'130px !important' },
            ...
            .getWorkOrderList(PagingData).subscribe(res => {
                const vList = res['results'].map(x => {
                    return {
                        ...
                        promisedDateType: x.promisedDateType ? this.datePipe.transform(x.promisedDateType, 'MMM-dd-yyyy hh:mm a') : '',
                        createdDate: x.createdDate ? this.datePipe.transform(x.createdDate, 'MMM-dd-yyyy hh:mm a') : '',
                        updatedDate: x.updatedDate ? this.datePipe.transform(x.createdDate, 'MMM-dd-yyyy hh:mm a') : '',
                    }
                });
