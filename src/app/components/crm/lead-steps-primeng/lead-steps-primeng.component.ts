...
@Component({
	selector: 'app-lead-create',
 	templateUrl: './lead-steps-primeng.component.html',
 	styleUrls: ['./lead-steps-primeng.component.scss'],
	animations: [fadeInOut]
})
export class LeadStepsPrimengComponent implements OnInit, AfterViewInit {
	...
	filterPrimary(event) {
        let data;
        if (!this.editMode) {
			if (this.leadInfo.secondarySalesPersonId !== undefined &&this.leadInfo.secondarySalesPersonId !== '' && this.leadInfo.secondarySalesPersonId !== null) {
            ...
            if (this.leadInfo.secondarySalesPersonId !== undefined) {
                data = [...this.leadList.filter(x => {
                    if (this.leadInfo.secondarySalesPersonId.employeeId !== x.employeeId) {
                        return x;
                    }
                })]
            } else {
