...
export class EntityAddComponent implements OnInit {
    ...
    ngOnInit() {
        // console.log("GeneralInformationData",this.editMode,this.GeneralInformationData)
    ...
    getLegalEntityList(strText = '') {
        ...
        this.commonService.autoSuggestionSmartDropDownList('LegalEntity', 'LegalEntityId', 'Name', strText, true, 20, this.arrayEntitylist.join()).subscribe(response => {
