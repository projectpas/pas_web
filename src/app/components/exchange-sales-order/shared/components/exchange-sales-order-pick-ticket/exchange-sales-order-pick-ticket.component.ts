...
@Component({
  selector: 'app-exchange-sales-order-pick-ticket',
  templateUrl: './exchange-sales-order-pick-ticket.component.html',
  styleUrls: ['./exchange-sales-order-pick-ticket.component.scss']
})
export class ExchangeSalesOrderPickTicketComponent implements OnInit {
  ...
  getSalesPickTicketView() {
    this.exchangeSalesOrderService.getPickTicketPrint(this.salesOrderId, this.salesOrderPartId, this.soPickTicketId).subscribe(res => {
