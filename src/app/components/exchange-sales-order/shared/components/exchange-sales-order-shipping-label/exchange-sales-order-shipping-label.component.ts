...
@Component({
  selector: 'app-exchange-sales-order-shipping-label',
  templateUrl: './exchange-sales-order-shipping-label.component.html',
  styleUrls: ['./exchange-sales-order-shipping-label.component.scss']
})
export class ExchangeSalesOrderShippingLabelComponent implements OnInit {
  ...
  getSalesPickTicketView() {
    this.exchangeSalesOrderService.getShippingLabelPrint(this.salesOrderId, this.salesOrderPartId, this.soShippingId).subscribe(res => {
  ...
  updateServiceClass() {
    this.exchangeSalesOrderService.updateShipping(this.salesOrderShipping.serviceClass, this.soShippingId).subscribe(res => {
      this.printContent();
    })
  }
