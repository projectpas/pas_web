...
import { ExchangeSalesOrderShippingLabelView } from "../../../../../models/exchange/ExchangeSalesOrderShippingLabelView";
//import { ISalesOrderCopyParameters } from "../models/isalesorder-copy-parameters";
import { AuthService } from "../../../../../services/auth.service";
@Component({
  selector: 'app-exchange-sales-order-multi-shipping-label',
  templateUrl: './exchange-sales-order-multi-shipping-label.component.html',
  styleUrls: ['./exchange-sales-order-multi-shipping-label.component.scss']
})
export class ExchangeSalesOrderMultiShippingLabelComponent implements OnInit {
  ...
  @Input() salesOrderView: ExchangeSalesOrderShippingLabelView;
  //salesOrderCopyParameters: ISalesOrderCopyParameters;
  salesshippingLabels: any = [];
  objSalesOrderShippingLabels: any = [];
  ...
  getSalesOrderShippingLabel() {
    this.exchangeSalesOrderService.getMultiShippingLabelPrint(this.salesshippingLabels).subscribe(res => {
  ...
  updateServiceClass() {
    ...
    this.objSalesOrderShippingLabels.forEach(element => {
      if (element.soShippingLabelViewModel.serviceClass != undefined) {
        this.exchangeSalesOrderService.updateShipping(element.soShippingLabelViewModel.serviceClass, element.soShippingLabelViewModel.soShippingId).subscribe(res => {
          i = i + 1;
