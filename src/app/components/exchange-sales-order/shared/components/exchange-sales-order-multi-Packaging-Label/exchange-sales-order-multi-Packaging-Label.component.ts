...
@Component({
  selector: 'app-exchange-sales-order-multi-Packaging-Label',
  templateUrl: './exchange-sales-order-multi-Packaging-Label.component.html',
  styleUrls: ['./exchange-sales-order-multi-Packaging-Label.component.scss']
})
export class ExchangeSalesOrderMultiPackagingLabelComponent implements OnInit {
  ...
  getPackagingSlipView() {
    ...
    this.exchangeSalesOrderService.getMultiPackagingSlipPrint(this.packagingSlips).subscribe(res => {
