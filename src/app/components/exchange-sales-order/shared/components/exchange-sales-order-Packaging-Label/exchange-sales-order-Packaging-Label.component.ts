...
@Component({
  selector: 'app-exchange-sales-order-Packaging-Label',
  templateUrl: './exchange-sales-order-Packaging-Label.component.html',
  styleUrls: ['./exchange-sales-order-Packaging-Label.component.scss']
})
export class ExchangeSalesOrderPackagingLabelComponent implements OnInit {
  ...
  getSalesPickTicketView() {
    ...
    this.exchangeSalesOrderService.getPackagingSlipPrint(this.salesOrderId, this.salesOrderPartId, this.soPickTicketId, this.packagingSlipId).subscribe(res => {
