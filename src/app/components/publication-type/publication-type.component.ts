...
export class PublicationTypeComponent implements OnInit {
    ...
    constructor(private breadCrumb: SingleScreenBreadcrumbService,
        ...
        public PublicationTypeService: publicationTypeService, private dialog: MatDialog, private masterComappublicationTypeServicenyService: MasterComapnyService, private configurations: ConfigurationService) {
    ...
    ngOnInit(): void {
        this.getList();
        this.breadCrumb.currentUrl = '/singlepages/singlepages/app-publication-type';
    ...
    getList() {
        this.PublicationTypeService.getAllWorkFlows().subscribe(res => {
    ...
    save() {
        ...
        if (!this.isEdit) {
            this.PublicationTypeService.newAction(data).subscribe(() => {
                this.resetForm();
                this.getList();
                this.alertService.showMessage(
                    'Success',
                    `Added  New Publication Type Successfully  `,
                    MessageSeverity.success
                );
            })
        } else {
            this.PublicationTypeService.updateAction(data).subscribe(() => {
    ...
    deleteConformation(value) {
        if (value === 'Yes') {
            this.PublicationTypeService.deleteAcion(
                this.selectedRowforDelete.publicationTypeId,
                 this.userName).subscribe(() => {
                this.getList();
                this.alertService.showMessage(
                    'Success',
                    `Deleted Publication Type Successfully  `,
                    MessageSeverity.success
                );
            })
        } else {
    ...
    getAuditHistoryById(rowData) {
        ...
        this.PublicationTypeService.historyintegration(rowData.publicationTypeId).subscribe(res => {
    ...
    sampleExcelDownload() {
        const url = `${this.configurations.baseUrl}/api/FileUpload/downloadsamplefile?moduleName=PublicationType&fileName=PublicationType.xlsx`;
    ...
    getListByStatus(status) {
        ...
        restorerecord:any={}
        restoreRecord(){  
            this.commonService.updatedeletedrecords('PublicationType',
            'PublicationTypeId',this.restorerecord.publicationTypeId, ).subscribe(res => {
                this.currentDeletedstatus=true;
                this.modal.close();
    ...
    //        this.formData.append('file', file[0])
    //        this.publicationTypeService.(this.formData).subscribe(res => {
    //            event.target.value = '';
