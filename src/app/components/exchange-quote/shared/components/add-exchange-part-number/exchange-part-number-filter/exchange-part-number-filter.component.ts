...
@Component({
  ...
  templateUrl: './exchange-part-number-filter.component.html',
  styleUrls: ['./exchange-part-number-filter.component.scss']
})
export class ExchangePartNumberFilterComponent implements OnInit, OnDestroy {
  @Input() customer: any;
