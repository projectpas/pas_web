...
@Component({
  selector: 'app-exchange-part-details',
  templateUrl: './exchange-part-details.component.html',
  styleUrls: ['./exchange-part-details.component.scss']
})
export class ExchangePartDetailsComponent implements OnChanges {
  @Input() customer: any;
  ...
  constructor(private exchangequoteService: ExchangequoteService, private service: StocklineService,
  ...
  ngOnInit() {
    this.exchangequoteService.getSearchPartResult()
      .subscribe(data => {
        this.parts = data;
        this.query = data;
